...
import com.example.android.mynewsapp.EmptyRecyclerView;
...
import com.example.android.mynewsapp.adapter.NewsAdapter;
...
public class BaseArticlesFragment extends Fragment
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.refresh_item, container, false);
